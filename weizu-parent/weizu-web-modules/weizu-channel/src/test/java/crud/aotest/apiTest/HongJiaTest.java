...
//		ExchangePlatformPo platformPo = exchangePlatformAO.getEpByEpName("红茄科技");
//		ProductCodePo dataPo = productCodeAO.getOneProductCodeByPg(41);//3元10M省漫游移动  
//		BaseP baseP = new BaseP(dataPo,"17122711482501520005",null,platformPo,DateUtil.formatPramm(System.currentTimeMillis(), "yyyyMMddHHmmss"));
//		baseP.setOrderId(771855250213572608l);
...
////		ProductCodePo dataPo = productCodeAO.getOneProductCodeByPg(41);//3元10M省漫游移动
////		BaseInterface bi = SingletonFactory.getSingleton(platformPo.getEpEngId(), new BaseP(dataPo,771855250213572608l,"13699562589",platformPo,DateUtil.formatPramm(System.currentTimeMillis(), "yyyyMMddHHmmss")));//其它参数用订单实际到达时间代替
