...
//		BaseInterface bi = SingletonFactory.getSingleton(platformPo.getEpEngId(), new BaseP(null,726633391352451072l,null,1,platformPo));
...
//		ExchangePlatformPo platformPo = exchangePlatformAO.getEpByEpName("仁智迈远");
//		BaseInterface bi = SingletonFactory.getSingleton(platformPo.getEpEngId(), new BaseP(null,"18340749",null,1,platformPo));
...
//		ExchangePlatformPo platformPo = exchangePlatformAO.getEpByEpName("仁智迈远");
//		BaseInterface bi = SingletonFactory.getSingleton(platformPo.getEpEngId(), new BaseP("10",766467363703885824l,"15754710513",1,platformPo));
