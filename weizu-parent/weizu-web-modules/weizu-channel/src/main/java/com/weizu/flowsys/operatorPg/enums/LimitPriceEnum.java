...
public enum LimitPriceEnum {
	...
	private LimitPriceEnum(String desc, Integer value) {
		this.desc = desc;
		this.value = value;
	}
	
	public static LimitPriceEnum getEnum(Integer value)
	{
		if (value == null)
		{
			return null;
		...
		LimitPriceEnum resultEnum = null;

		// 获取附件类型枚举数组
		LimitPriceEnum[] enumArray = LimitPriceEnum.values();

		for (LimitPriceEnum BillTypeEnum : enumArray)
		{
