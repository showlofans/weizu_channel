...
//
///**
// * @description:上家通道折扣实体
// * @projectName:crud
// * @className:ChannelForwardPo.java
// * @author:POP产品研发部 宁强
// * @createTime:2017年5月10日 上午10:57:07
// * @version 1.0
// */
//@TableName(name="channel_forward")
//public class ChannelForwardPo extends Po implements Cloneable {
//	
...
//    
//    @Override
//	public ChannelForwardPo clone() {
//    	ChannelForwardPo channelForwardPo = null; 
//    	 try{  
//    		 channelForwardPo = (ChannelForwardPo)super.clone();  
