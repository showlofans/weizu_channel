...
public enum TelChannelTagEnum {
	...
	private TelChannelTagEnum(String desc, Integer value) {
		this.desc = desc;
		this.value = value;
	}
	public static TelChannelTagEnum getEnum(Integer value)
	{
		if (value == null)
		{
			return null;
		...
		TelChannelTagEnum resultEnum = null;

		// 获取附件类型枚举数组
		TelChannelTagEnum[] enumArray = TelChannelTagEnum.values();

		for (TelChannelTagEnum agencyTagEnum : enumArray)
		{
