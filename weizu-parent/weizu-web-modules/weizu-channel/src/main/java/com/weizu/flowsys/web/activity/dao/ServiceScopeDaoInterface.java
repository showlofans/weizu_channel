...
/**
 * @description:流量包业务范围dao层接口
 * @projectName:crud
 * @className:ServiceScopeDaoInterface.java
 * @author:POP产品研发部 宁强
 * @createTime:2017年5月10日 下午2:12:00
 * @version 1.0
 */
public interface ServiceScopeDaoInterface {
	 ...
	 */
	String getServiceScopeId(Map<String,Object> params);
