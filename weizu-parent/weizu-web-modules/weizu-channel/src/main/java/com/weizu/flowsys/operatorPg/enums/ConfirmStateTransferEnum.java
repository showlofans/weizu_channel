...
//	INCOMPLETE_CONFIRM("待完善",3),
	...
	private ConfirmStateTransferEnum(String desc, Integer value) {
		this.desc = desc;
		this.value = value;
	}
	
	public static ConfirmStateTransferEnum getEnum(Integer value)
	{
		if (value == null)
		{
			return null;
		...
		ConfirmStateTransferEnum resultEnum = null;

		// 获取附件类型枚举数组
		ConfirmStateTransferEnum[] enumArray = ConfirmStateTransferEnum.values();

		for (ConfirmStateTransferEnum BillTypeEnum : enumArray)
		{
	...
	public static Map<String, Map<String, Object>> toMap()
	{
		...
		for (ConfirmStateTransferEnum confirmStateEnum : enumArray)
		{
