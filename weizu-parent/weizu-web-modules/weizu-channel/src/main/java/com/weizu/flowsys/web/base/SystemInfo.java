...
//import com.weizu.flowsys.web.otherPart.SystemFilePo;
...
//        List<SystemFilePo> fileList = new ArrayList<SystemFilePo>();
...
//            	String totalSize =  NumberTool.div(usage.getTotal(), 1024*1024) +"G";
//            	String freeSize =  NumberTool.div(usage.getFree(), 1024*1024) +"G";
//            	String availSize =  NumberTool.div(usage.getAvail(), 1024*1024) +"G";
//            	String usedSize =  NumberTool.div(usage.getUsed(), 1024*1024) +"G";
            	double usePercent = usage.getUsePercent() * 100D;  
            	resultMap.put("totalSize", NumberTool.div(usage.getTotal(), 1024*1024,2) +"G");//devName + "总大小:    " + 
            	resultMap.put("freeSize",  NumberTool.div(usage.getFree(), 1024*1024,2) + "G");//devName + "剩余大小:    " +
            	resultMap.put("availSize",  NumberTool.div(usage.getAvail(), 1024*1024,2) + "G");//devName +"可用大小:    " +
            	resultMap.put("usedSize",  NumberTool.div(usage.getUsed(), 1024*1024,2) +"G");//devName + "已经使用量:    " +
            	resultMap.put("usePercent",usePercent + "%");// devName + "资源的利用率:    " + 
            	resultMap.put("devName",devName);// devName + "资源的利用率:    " + 
//            	String usePercentStr =  usePercent + "%";
//            	SystemFilePo systemFilePo = new SystemFilePo(devName, totalSize, freeSize, availSize, usedSize, usePercentStr);
//            	fileList.add(systemFilePo);
//            	// 文件系统总大小  
//                System.out.println(devName + "总大小:    " + NumberTool.div(usage.getTotal(), 1024*1024) +"G");  
//                // 文件系统剩余大小  
//                System.out.println(devName + "剩余大小:    " + NumberTool.div(usage.getFree(), 1024*1024) + "G");  
//                // 文件系统可用大小  
//                System.out.println(devName + "可用大小:    " + NumberTool.div(usage.getAvail(), 1024*1024) + "G");  
//                // 文件系统已经使用量  
//                System.out.println(devName + "已经使用量:    " + NumberTool.div(usage.getUsed(), 1024*1024) +"G");  
//                // 文件系统资源的利用率  
//                System.out.println(devName + "资源的利用率:    " + usePercent + "%");  
                break;  
