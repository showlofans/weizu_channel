 ...
 * @className:CrmPlatformTagEnum.java
 * @author:微族通道代码设计人 宁强
 * @createTime:2018年1月3日 下午4:00:51
 * @version 1.0
 */
public enum CrmPlatformTagEnum {
	/**
	 * 已对接 - 1
	 */
	DATA_USER("已对接",1),
	...
	private CrmPlatformTagEnum(String desc, Integer value) {
		this.desc = desc;
		this.value = value;
	}
	public static CrmPlatformTagEnum getEnum(Integer value)
	{
		if (value == null)
		{
			return null;
		...
		CrmPlatformTagEnum resultEnum = null;

		// 获取附件类型枚举数组
		CrmPlatformTagEnum[] enumArray = CrmPlatformTagEnum.values();

		for (CrmPlatformTagEnum agencyTagEnum : enumArray)
		{
