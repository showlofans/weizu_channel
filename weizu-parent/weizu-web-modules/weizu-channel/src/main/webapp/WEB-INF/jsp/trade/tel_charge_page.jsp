...
<article class="page-container">
	...
	<div class="row cl" id="pg">
		...
		<div class="formControls col-xs-8 col-sm-9">
		<!--  onfocus="ajaxPg()" -->
			<textarea readonly="readonly" style="height:350px;  " name="" cols="30" rows="" class="textarea"  placeholder="充值介绍
市内（只限本市号码可充值）
省内（只限本省号码可充值）
全国（全国号码均可充值  ）

快充（一般1-10分钟到账，具体以查询官方为准）
慢充（一般24/48小时到账，具体以工作人员通知为准）

温馨提示：
充值成功后1-10分钟后到账
充值结果可在，订单列表里面查询
是否到账具体以官方到账为准
如遇长时间的充值等待——充值失败等一系列原因，亲联系您的上游，咨询
售后流程，我司售后规则是24小时，24小时后，提供服务密码/网厅截图。核实未到账后，退款，一般未到账几率是0.03%

本司上班时间，9.00-00.00
如遇休息时间，亲耐心等待，
一切只为更好的服务，如有给您带来不便之处，敬请谅解"></textarea>
		</div>
	</div>
	</form>
...
/*  function showNext(vart){
 ...
 /**通过用户手机号获得基本信息*/
    ...
    var reg = /^(13|14|15|18)[0-9]{9}$/;//点击查询
    function ajaxPhone(){
