...
<div class="page-container">
	<div class="text-c">
	<form class="form form-horizontal" action="/flowsys/telRate/agency_telchannel_list.do" method="post" id="formD" name="dataListForm">
			...
			<tbody>
				<c:forEach items="${resultMap.pagination.records }" var="telchannel" varStatus="vs">
					<tr class="text-c <c:if test='${telchannel.rateForPlatform != 1 }'>warning</c:if>">
						...
						<td>
							<a style="text-decoration:none" data-toggle="tooltip" data-href='/flowsys/telRate/telRate_add_page_plat.do?activeId=${telchannel.id }&serviceType=${telchannel.serviceType }' data-placement="top" class="ml-5" onclick="Hui_admin_tab(this)" data-title="配置折扣"><i class="Hui-iconfont">&#xe72b;</i></a>
						</td>
						<%--  <td class="td-status">
							<c:forEach items="${resultMap.channelStateEnums }" var="cState" varStatus="vs1">
