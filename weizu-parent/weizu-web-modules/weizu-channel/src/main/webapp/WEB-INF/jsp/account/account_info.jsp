...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页
	...
	<c:choose>
		...
		<c:when test="${ resultMap.secondAgency && fn:indexOf(resultMap.rootAgency.otherContact, '&') > 0 }"><!-- 二级代理商可以用分割的方式获得上级root用户的所有联系方式 -->
			<%-- <c:set var="qqIndex">${fn:indexOf(qq, '&') }</c:set> --%>
			<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=${fn:substringBefore(resultMap.rootAgency.otherContact, '&') }&site=qq&menu=yes"><img border="0" src="/view/button_111.gif" alt="点击这里给我发消息" title="点击这里给我发消息"/></a>
		...
		<c:otherwise>
			<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=${resultMap.rootAgency.otherContact }&site=qq&menu=yes"><img border="0" src="/view/button_111.gif" alt="点击这里给我发消息" title="点击这里给我发消息"/></a>
		</c:otherwise>
	</c:choose>
</nav>
