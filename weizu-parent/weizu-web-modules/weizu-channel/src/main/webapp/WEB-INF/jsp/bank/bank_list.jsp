...
<div class="page-container">
	...
	<p>上次登录IP：222.35.131.79.1  上次登录时间：2014-6-14 11:19:55</p> -->
	 ...
	 <table class="table table-border table-bordered table-bg">
		<thead>
			<tr >
				<th colspan="7" scope="col">对公账户余额：${chargeAccount1.accountBalance } 
					<span class="text-r">
					...
					<c:forEach items="${resultMap.bankList }" var="bank" varStatus="vst">
						<tr class="text-c">
							...
							<td class="td-manage">
								...
								<a style="text-decoration:none" data-toggle="tooltip" data-placement="top" class="ml-5" onClick="bank_del('/flowsys/bankAccount/del_bank.do',${bank.id }, '${bank.accountName }')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a>
	...
	<p></p>
	 <table class="table table-border table-bordered table-bg">
		<thead>
			<tr>
				<th colspan="7" scope="col">对私账户余额：${chargeAccount.accountBalance }</th>
			</tr>
			<tr class="text-c">
				<th>银行卡名称</th>
				<th>银行卡账号</th>
