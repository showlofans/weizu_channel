				...
				<c:forEach items="${resultMap.pagination.records }" var="agency" varStatus="vs">
					<tr class="text-c font-red">
						...
						<td class="td-manage">
							...
							<a data-toggle="tooltip" data-placement="top" style="text-decoration:none"  title="活动费率列表" data-href="/flowsys/rate/bind_channel_list.do?agencyId=${agency.id }&agencyName=${agency.userName}" data-title="活动费率列表" onclick="Hui_admin_tab(this)"><i class="Hui-iconfont">&#xe6df;</i></a>
						</td>
