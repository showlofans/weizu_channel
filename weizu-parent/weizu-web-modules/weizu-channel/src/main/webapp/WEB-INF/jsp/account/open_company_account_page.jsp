	...
	<form action="" method="post" class="form form-horizontal" enctype=”multipart/form-data” id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="公司名称" required id="" name="companyName">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>公司地址：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="公司地址" id="" name="companyLocation">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>公司（负责人）联系电话：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="公司（负责人）联系电话" id="" name="corporateTel">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="开户行名称" id="" name="depositBankName">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>银行账号：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="银行账号" id="" name="bankAccount">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>税务登记证号：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="税务登记证号" id="" name="taxRegistrationCertificate">
			</div>
		</div>
		<!-- <div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="企业现居地址" id="" name="companyAddress">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" name="billRecipientsName" id="" placeholder="发票收件人" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">收件人电话：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" name="billRecipientsTel" id="" placeholder="收件人电话" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="商务负责人姓名" id="" name="businessExecutiveName">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">商务联系电话：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="商务联系电话" id="" name="beTel">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">紧急联系人姓名：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="紧急联系人姓名" id="" name="emergencyContact">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">紧急联系人电话：</label>
			<div class="formControls col-xs-7 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="紧急联系人电话" id="" name="ecTel">
			</div>
		</div>
		<div class="row cl">
