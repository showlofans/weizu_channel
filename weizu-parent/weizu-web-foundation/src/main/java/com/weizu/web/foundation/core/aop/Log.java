package com.weizu.web.foundation.core.aop;
...
public class Log {
	...
	@Pointcut("@annotation(org.weizu.web.foundation.core.annotation.po.Log)")
		...
		for (Method method : methods) {
			if (method.getName().equals(name)) {
				...
				if (clazzs.length == arguments.length) {
					...
					methodName = method.getAnnotation(com.weizu.web.foundation.core.annotation.po.Log.class).action();
